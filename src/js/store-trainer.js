...
const sectionTemplates = {
  batches: `
    ...
    <section class="panel"><div class="panel-heading"><div><h2>Assigned Training Batches</h2><p>Training schedule, trainee count, and completion progress</p></div></div><div class="table-wrap"><table><thead><tr><th>Training Batch</th><th>Branch</th><th>Trainees</th><th>Training Period</th><th>Progress</th><th>Status</th></tr></thead><tbody>
      <tr data-search="Pulilan Crew Batch A Manila 12 trainees ongoing"><td><strong>Pulilan Crew Batch A</strong><span>TRN-2607-A</span></td><td>Pulilan, Manila</td><td>12</td><td>July 15–29</td><td>75%</td><td><span class="status good">Ongoing</span></td></tr>
      <tr data-search="Calumpit Crew Batch B 12 trainees in progress"><td><strong>Calumpit Crew Batch B</strong><span>TRN-2607-B</span></td><td>Calumpit Central</td><td>12</td><td>July 18–August 1</td><td>60%</td><td><span class="status good">In Progress</span></td></tr>
      <tr data-search="Malolos Crew Batch D 11 trainees needs attention"><td><strong>Malolos Crew Batch D</strong><span>TRN-2607-D</span></td><td>Malolos Avenue</td><td>11</td><td>July 16–30</td><td>45%</td><td><span class="status attention">Needs Attention</span></td></tr>
      <tr data-search="Mexico, Pampanga Crew Batch C completed certified"><td><strong>Mexico, Pampanga Crew Batch C</strong><span>TRN-2606-C</span></td><td>Mexico, Pampanga Central</td><td>10</td><td>June 25–July 10</td><td>100%</td><td><span class="status strong">Completed</span></td></tr>
 ...
 assessments: `
  ...
  <section class="panel">
    ...
    <section class="panel"><div class="panel-heading"><div><h2>Employee Certification Status</h2><p>Only certified employees may be deployed to active stores</p></div></div><div class="table-wrap"><table><thead><tr><th>Employee</th><th>Batch</th><th>Assessment Score</th><th>Certification Status</th><th>Deployment</th><th></th></tr></thead><tbody>
      <tr data-search="Andrea Reyes awaiting certification eligible"><td><strong>Andrea Reyes</strong><span>EMP-26121 • Service Crew</span></td><td>Calumpit Crew Batch B</td><td>90%</td><td><span class="table-status investigating">For Certification</span></td><td>Not Yet Eligible</td><td><button class="review-btn certify-btn" data-name="Andrea Reyes">Certify</button></td></tr>
      <tr data-search="Carlo Mendoza certified deployment ready"><td><strong>Carlo Mendoza</strong><span>EMP-26118 • Kitchen Crew</span></td><td>Calumpit Crew Batch B</td><td>89%</td><td><span class="table-status monitoring">Certified</span></td><td>Ready for Deployment</td><td><button class="review-btn">View</button></td></tr>
      <tr data-search="Joshua Lim requires retraining not eligible"><td><strong>Joshua Lim</strong><span>EMP-26127 • Kitchen Crew</span></td><td>Pulilan Crew Batch A</td><td>74%</td><td><span class="table-status action">Requires Retraining</span></td><td>Not Eligible</td><td><button class="review-btn">Assign Coaching</button></td></tr>
    </tbody></table></div></section>`,
