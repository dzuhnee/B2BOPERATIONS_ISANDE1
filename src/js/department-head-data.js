window.departmentHeadData={
  ...
  proposals:[
    {id:'SP-2026-041',site:'Ayala Malls Manila Bay',location:'Parañaque City',submittedBy:'Rina Flores',score:92,classification:'Highly Viable',stage:'Finance Review',status:'Pending Review',submitted:'2026-07-17',deadline:'2026-07-23',opening:'2026-10-12',address:'Diosdado Macapagal Blvd., Parañaque City',strengths:'High weekday foot traffic; excellent public transport access.',risks:'Premium lease rate and shared loading-bay schedule.',recommendations:'Negotiate a five-year rent cap and confirm peak-hour delivery access.',documents:[['Site Proposal','Proposal','Jul 17','Verified'],['Market Evaluation','Research','Jul 16','Verified'],['Financial Feasibility Report','Finance','Jul 17','Verified'],['Lease Information','Legal','Jul 15','Pending Verification']],history:[['Business Development','Rina Flores','Completed','Endorsed after market validation.','Jul 17, 2:14 PM'],['Legal','Atty. Maya Santos','Approved','Lease conditions acceptable subject to final annex.','Jul 19, 10:35 AM']]},
