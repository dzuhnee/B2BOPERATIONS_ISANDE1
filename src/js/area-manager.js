...
const sectionTemplates = {
  branches: `
    ...
    <div class="stats-grid">
      ...
      <article class="stat-card"><div class="stat-icon orange"><i data-lucide="circle-alert"></i></div><div><span>Needs Attention</span><strong>1</strong><small>Paombong, Bulacan</small></div></article>
    </div>
    <section class="panel"><div class="panel-heading"><div><h2>Assigned Franchise Branches</h2><p>Operational status, manager, and latest report</p></div></div><div class="table-wrap"><table><thead><tr><th>Branch</th><th>Branch Manager</th><th>Daily Report</th><th>Performance</th><th>Status</th></tr></thead><tbody>
      <tr data-search="Pulilan, Bulacan Bulacan Andrea Cruz"><td><strong>Pulilan, Bulacan</strong><span>Branch 001 • Bulacan</span></td><td>Andrea Cruz</td><td>Submitted 8:42 AM</td><td>96%</td><td><span class="status strong">Strong</span></td></tr>
      <tr data-search="Pandi, Bulacan Bulacan Luis Santos"><td><strong>Pandi, Bulacan</strong><span>Branch 003 • Bulacan</span></td><td>Luis Santos</td><td>Submitted 9:05 AM</td><td>94%</td><td><span class="status strong">Strong</span></td></tr>
      <tr data-search="Mexico, Pampanga Pampanga Camille Reyes"><td><strong>Mexico, Pampanga</strong><span>Branch 006 • Pampanga</span></td><td>Camille Reyes</td><td>Submitted 10:10 AM</td><td>91%</td><td><span class="status good">Good</span></td></tr>
      <tr data-search="Paombong, Bulacan Bulacan Marco Lim"><td><strong>Paombong, Bulacan</strong><span>Branch 008 • Bulacan</span></td><td>Marco Lim</td><td>Pending</td><td>78%</td><td><span class="status attention">Needs Attention</span></td></tr>
      <tr data-search="Malolos, Bulacan Bulacan Nina Flores"><td><strong>Malolos, Bulacan</strong><span>Branch 004 • Bulacan</span></td><td>Nina Flores</td><td>Pending</td><td>87%</td><td><span class="status good">Good</span></td></tr>
  ...
  reports: `
    ...
    <div class="stats-grid"><article class="stat-card"><div class="stat-icon green"><i data-lucide="file-check-2"></i></div><div><span>Submitted</span><strong>6</strong><small>Out of 8 branches</small></div></article><article class="stat-card"><div class="stat-icon yellow"><i data-lucide="hourglass"></i></div><div><span>Pending</span><strong>2</strong><small>Malolos and Paombong</small></div></article><article class="stat-card"><div class="stat-icon red"><i data-lucide="receipt-text"></i></div><div><span>For Review</span><strong>3</strong><small>Flagged operational notes</small></div></article><article class="stat-card"><div class="stat-icon green"><i data-lucide="circle-check-big"></i></div><div><span>Reviewed</span><strong>3</strong><small>Completed by Bea</small></div></article></div>
    ...
    <tr data-search="Pulilan, Bulacan submitted reviewed"><td><strong>Pulilan, Bulacan</strong><span>DR-0720-001</span></td><td>8:42 AM</td><td>Above target</td><td>No issues</td><td><span class="table-status monitoring">Reviewed</span></td><td><button class="review-btn report-review" data-incident="Pulilan, Bulacan Daily Report">Open</button></td></tr>
    <tr data-search="Pandi, Bulacan submitted for review"><td><strong>Pandi, Bulacan</strong><span>DR-0720-003</span></td><td>9:05 AM</td><td>On target</td><td>Minor staffing note</td><td><span class="table-status investigating">For Review</span></td><td><button class="review-btn report-review" data-incident="Pandi, Bulacan Daily Report">Review</button></td></tr>
    <tr data-search="Mexico, Pampanga submitted for review"><td><strong>Mexico, Pampanga</strong><span>DR-0720-006</span></td><td>10:10 AM</td><td>On target</td><td>POS issue monitored</td><td><span class="table-status investigating">For Review</span></td><td><button class="review-btn report-review" data-incident="Mexico, Pampanga Daily Report">Review</button></td></tr>
    <tr data-search="Paombong, Bulacan pending"><td><strong>Paombong, Bulacan</strong><span>DR-0720-008</span></td><td>Pending</td><td>—</td><td>—</td><td><span class="table-status action">Pending</span></td><td><button class="review-btn">Send Reminder</button></td></tr>
    </tbody></table></div></section>`,
  incidents: `
    ...
    <tr data-search="Freezer temperature fluctuation Paombong, Bulacan high"><td><strong>Freezer temperature fluctuation</strong><span>INC-2026-0719</span></td><td>Paombong, Bulacan</td><td>Today, 9:12 AM</td><td><span class="priority high">High</span></td><td><span class="table-status investigating">Under Investigation</span></td><td><button class="review-btn" data-incident="Freezer temperature fluctuation">Review</button></td></tr>
    <tr data-search="Delayed opening staffing Malolos, Bulacan high"><td><strong>Delayed opening due to staffing</strong><span>INC-2026-0718</span></td><td>Malolos, Bulacan</td><td>Yesterday, 7:45 AM</td><td><span class="priority high">High</span></td><td><span class="table-status action">Action Required</span></td><td><button class="review-btn" data-incident="Delayed opening due to staffing">Review</button></td></tr>
    <tr data-search="POS terminal error Mexico, Pampanga medium"><td><strong>POS terminal intermittent error</strong><span>INC-2026-0716</span></td><td>Mexico, Pampanga</td><td>July 18, 2026</td><td><span class="priority medium">Medium</span></td><td><span class="table-status monitoring">Monitoring</span></td><td><button class="review-btn" data-incident="POS terminal intermittent error">Review</button></td></tr>
    </tbody></table></div></section>`,
  actions: `
    ...
    <tr data-search="Inspect freezer sensors Paombong"><td><strong>Inspect and recalibrate freezer sensors</strong><span>CA-2026-041</span></td><td>Paombong, Bulacan</td><td>Marco Lim</td><td>July 20</td><td>40%</td><td><span class="table-status action">Overdue</span></td></tr>
    <tr data-search="staffing contingency Malolos"><td><strong>Submit opening-shift staffing contingency plan</strong><span>CA-2026-039</span></td><td>Malolos, Bulacan</td><td>Nina Flores</td><td>July 21</td><td>70%</td><td><span class="table-status investigating">In Progress</span></td></tr>
    <tr data-search="POS diagnostics Mexico"><td><strong>Complete POS terminal diagnostics</strong><span>CA-2026-037</span></td><td>Mexico, Pampanga</td><td>Camille Reyes</td><td>July 22</td><td>85%</td><td><span class="table-status monitoring">Monitoring</span></td></tr>
    </tbody></table></div></section>`,
  performance: `
    ...
    <div class="stats-grid"><article class="stat-card"><div class="stat-icon green"><i data-lucide="trending-up"></i></div><div><span>Area Average</span><strong>91%</strong><small><b>+3.2%</b> vs. last month</small></div></article><article class="stat-card"><div class="stat-icon red"><i data-lucide="trophy"></i></div><div><span>Top Branch</span><strong>96%</strong><small>Pulilan, Bulacan</small></div></article><article class="stat-card"><div class="stat-icon yellow"><i data-lucide="star"></i></div><div><span>Target Met</span><strong>6/8</strong><small>Two branches below 90%</small></div></article><article class="stat-card"><div class="stat-icon orange"><i data-lucide="arrow-up-right"></i></div><div><span>Most Improved</span><strong>+8%</strong><small>Mexico, Pampanga</small></div></article></div>
    <div class="dashboard-grid"><section class="panel"><div class="panel-heading"><div><h2>Branch Ranking</h2><p>Composite score from reports, incidents, and compliance</p></div></div><div class="branch-list">
      <article class="branch-row"><div class="branch-rank">1</div><div class="branch-name"><strong>Pulilan, Bulacan</strong><span>Excellent operational consistency</span></div><div class="score"><strong>96%</strong><div><span style="width:96%"></span></div></div><span class="status strong">Strong</span></article>
      <article class="branch-row"><div class="branch-rank">2</div><div class="branch-name"><strong>Pandi, Bulacan</strong><span>Stable month-on-month results</span></div><div class="score"><strong>94%</strong><div><span style="width:94%"></span></div></div><span class="status strong">Strong</span></article>
      <article class="branch-row"><div class="branch-rank">3</div><div class="branch-name"><strong>Mexico, Pampanga</strong><span>Highest monthly improvement</span></div><div class="score"><strong>91%</strong><div><span style="width:91%"></span></div></div><span class="status good">Good</span></article>
      <article class="branch-row"><div class="branch-rank">8</div><div class="branch-name"><strong>Paombong, Bulacan</strong><span>Incident resolution needs attention</span></div><div class="score"><strong>78%</strong><div><span style="width:78%"></span></div></div><span class="status attention">Needs Attention</span></article>
    </div></section><section class="panel"><div class="panel-heading"><div><h2>Area Manager Focus</h2><p>Recommended priorities</p></div></div><div class="timeline"><div class="timeline-item"><span class="dot red"><i data-lucide="triangle-alert"></i></span><div><strong>Resolve Paombong equipment incident</strong><p>Confirm technician visit and food-safety controls.</p><small>High priority</small></div></div><div class="timeline-item"><span class="dot yellow"><i data-lucide="users"></i></span><div><strong>Review Malolos staffing plan</strong><p>Prevent another delayed branch opening.</p><small>Due tomorrow</small></div></div><div class="timeline-item"><span class="dot green"><i data-lucide="award"></i></span><div><strong>Recognize Pulilan performance</strong><p>Share branch practices with the area network.</p><small>Recommended</small></div></div></div></section></div>`,
  settings: `
